...
log4j = {
  ...
  //
  appenders {
    console name: 'stdout', layout: pattern(conversionPattern: '%d{ yyyyMMdd HH:mm:ss} %c %m%n')
  }
  ...
  environments {
    ...
    development {
      debug 'grails.app.services',
        ...
        'grails.app.controllers.grails.plugins.springsocial'
      'org.pac4j'
...
plugin.springSocialCore.pageDeniedHome = "/springSocialFacebook/index"
plugin.springSocialCore.postDisconnectUri = "/demo/index"
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
  '/'                             : ['permitAll'],
  '/demo/**'                      : ['isFullyAuthenticated()'],
  '/dbconsole/**'                    : ['isFullyAuthenticated()'],
  '/index.gsp'                    : ['permitAll'],
  '/ssconnect/**'                 : ['permitAll'],
  '/sssignin/**'                  : ['permitAll'],
